...
<head>
		...
		<title>seedmail - campanhas marketing e-mails sms</title>	

		<meta name="keywords" content="e-mails sms campanhas marketing" />
		<meta name="description" content="Campanhas de marketing e-mails e sms para a sua empresa simples eficiente e intuitivo">
		<meta name="author" content="Seedmail">
		...
		<script type="text/javascript">
			$(window).scroll(function() {
					...
					if ( $(window).scrollTop() >= 150 ) {
						$('#headermenu').css('border-bottom-color', '#e9e9e9');
						$('#headermenu').css('box-shadow', '0 0 3px rgba(0, 0, 0, 0.1)');
...
<div role="main" class="main">
					...
					<div class="col-md-2">
						...
						<div class="col-md-8">
							...
							<div class="alert alert-danger hidden" id="contactError">
								<strong>Erro!</strong> Ocorreu um erro ao enviar a sua mensagem.
							</div>

							<h2 class="mb-sm mt-sm">Fale conosco</h2>
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											...
											<textarea maxlength="5000" data-msg-required="Por favor insira a mensagem." rows="10" class="form-control" name="message" id="message" required></textarea>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<input style="width:100%;" type="submit" value="Enviar Mensagem" class="btn btn-primary btn-lg mb-xlg" data-loading-text="Loading...">
									</div>
								</div>
							</form>
						</div>
		...
		<script>
			...
			*/
			...
			// Map Markers
			var mapMarkers = [{
				address: "41.189840, -8.441997",
				html: "<strong>B2CLOUD</strong><br>Rua de Correlo 4, 14<br />4585-384 Gandra, Paredes, Portugal<br />41.189840, -8.441997",
				icon: {
					image: "img/pin.png",
					iconsize: [26, 46],
					iconanchor: [12, 46]
			...
			var initLatitude = 41.189840;
			var initLongitude = -8.441997;
